# Taguchi Orthogonal Arrays for Hyperparameter Optimization

## Overview

The Taguchi library implements orthogonal array experimental design for
efficient hyperparameter optimization. This approach reduces the number of
experimental runs compared to exhaustive search while maintaining statistical
power to identify significant factors and optimal configurations.
...
with Experiment() as exp:
    ...
    # Automatically selects appropriate orthogonal array
    runs = exp.generate()
...
| Factors | Levels | Full Factorial | Taguchi Array | Reduction |
|---------|--------|---------------|---------------|-----------|
| 3       | 3      | 27 runs        | 9 (L9)        | 67%       |
| 4       | 3      | 81 runs        | 9 (L9)        | 89%       |
